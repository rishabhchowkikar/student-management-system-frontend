...
const Navbar = () => {
    ...
    return (
        <div className='relative'>
            <nav className="sticky top-0 left-0 w-full h-20 border-b border-gray-200 bg-bgPrimary-100">
                <div className="container mx-auto h-full flex items-center justify-between px-4">
                    {/* Logo on the left */}
                    <div className="flex items-center">
                        <Image src={navbar_logo} alt="navbar_logo" className="w-full h-auto" draggable={false} />
                    </div>
